...
##'  \itemize{
##' \item{\bold{optimFit:} a list generated by the optim function}
...
##' @import stats
##' 
##' @details he model likelihood is maximized using methods available in \code{\link[stats]{optim}}.  Optimization methods to be used within optim can be specified through the control object (i.e., control$method).  The default method is L-BFGS-B with bounds specific to each model. 
##' \itemize{
...
##' \item{\bold{cont.quality.1} this is manzoni? / bolker?}
...
fit_litter <- function(time, mass.remaining, model=c("neg.exp","weibull","discrete.parallel","discrete.series","cont.quality.1","cont.quality.2","neg.exp.limit"),iters=500,...){
